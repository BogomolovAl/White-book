...
Есть блокчейн == книга учёта контрактов и балансов. Абсолютно вся логика работы приложения хранится в блокчейне.

Есть VPS разработчика сайта, на котором хранятся 
