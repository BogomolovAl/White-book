...
Наблюдая за производственным процессом, я успел оценить:
* насколько затратна финансово и по времени концепция со съёмкой видео
...
Словом, предлагается сделать Эдьюкейтопедию с рекламой, 100% от доходов с которой идёт автору курса. 

##### Ты предлагаешь то, что уже сделала Khan Academy
...
Курсера, edX, [огромный список] — классическое университетское образование
Udacity, Codeschool, Codecademy — IT-курсы
Khan Academy и только они — школьное образование. 

мне кажется хорошей идеей полностью размыть грань между школой и университетом (это оффтоп, впрочем)
...
Покончив со вступительной частью, перейдём к прямым размышлениям о том, откуда брать сумасшедший заработок для презентера. Вариант "презентеру автоматически уходит часть заработка ассистента" не годится — презентер не должен зарабатывать пропорционально неясным моментам своего курса.

Заработок презентера, в идеале, должен быть пропорционален количеству часов, которое публика работает с его материалами.

В связи с этим у меня есть предложение, в котором я не уверен, но ничего лучше придумать пока не могу (и ютуб вот тоже не может). Видимо, надо показывать удачно встроенную в интерьер сайта рекламу сбоку (не в видеоролики, неяркую; хороший пример — реклама ВКонтакте). Соответственно, каждому из презентеров выплачивается некоторый (большой) процент от рекламных доходов; в личном кабинете каждый из них может посмотреть, сколько часов (в сумме) пользователи залипают на его материалах, сколько рекламы за это время было показано и какой доход он может вывести в реальные деньги в любой момент.
