...
Если совсем по-русски, история очень простая. В реальном мире есть бумажные деньги (печатающиеся по желанию левой пятки Набиуллиной) и контракты, написанные на бумаге (исполнение которых гарантировано басманным правосудием). К счастью, с 2009 в природе также существуют криптовалюты, выпуск которых происходит согласно алгоритму, который невозможно изменить (протоколу криптовалюты). Первой такой валютой стал Биткойн. Эфириум развивает одну сторону Биткойн: возможность использовать Bitcoin-like способ достижения децентрализованного соглашения не только для того, чтобы договариваться, у кого сколько денег и кто кому сколько переслал, но также и 

Смарт-контракты — это контракты, написанные не на бумаге, а в виде программного кода. Смарт-контракт, в отличие от контракта бумажного, не может быть не выполнен, потому что, однажды отправленный в сеть (аналог из реальной жизни — подписанный сторонами договор), его код невозможно изменить. Деньги вкладываются в контракт. [Один из возможных примеров смарт-контракта.](https://github.com/snordenstorm/wiki/wiki/%5BRussian%5D-White-Paper#%D0%A4%D0%B8%D0%BD%D0%B0%D0%BD%D1%81%D0%BE%D0%B2%D1%8B%D0%B5-%D0%B4%D0%B5%D1%80%D0%B8%D0%B2%D0%B0%D1%82%D0%B8%D0%B2%D1%8B-%D0%B8-%D1%85%D0%B5%D0%B4%D0%B6%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D1%80%D0%B8%D1%81%D0%BA%D0%BE%D0%B2)

История со смарт-контрактами, по-видимому, приведёт к тому, что (в прогрессивных странах) ВЕСЬ документооборот будет со временем перемещён в Эфириум-блокчейн (или во что-то подобное). Профессия нотариуса вымрет.

На самом деле ещё много чего поменяется.
...
Буквальный перевод (block chain) намекает нам на то, что это цепочка блоков; так оно, в общем, и есть.
* Метакойны — 
