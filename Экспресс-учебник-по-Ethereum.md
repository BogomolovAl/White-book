...
* Блокчейн — базовое понятие архитектуры сети Биткойн, сердце всей идеи. Буквальный перевод (block chain) намекает нам на то, что это цепочка блоков; так оно, в общем, и есть. Валюта Биткойн, по-видимому, является лишь первым успешным применением блокчейн-технологии; другие возможные применения сулят какие-то совсем грандиозные общественные преобразования.
* Метакойны — 
