...
Одним из священных Граалей исследований в области искусственного интеллекта является концепция произвольного самоизменяющегося кода — кода, который может изменять себя любым образом, теоретически развиваясь до неограниченных уровней интеллекта. В умеренной форме такая концепция может применяться в протоколах ДАО, где отдельные участники (люди) предлагают изменения в протоколе, и, если при голосовании набран необходимый процент, код в соответствии с результатами голосования сам себя изменяет. Общей проблемой всех таких протоколов всегда была стабильность. Рассмотрим следующий алгоритм:
...
И мы получаем бессмысленную функцию, всегда возвращающую 1 или попадающую в бесконечный цикл.
