...
У всех сервисов, которыми вы пользуетесь в повседневности, есть нечто общее: они централизованы. Когда вы размещаете деньги в банке, вам приходится доверять ему — доверять его честности, соблюдении им банковской тайны, защищённости от хакеров и государственного давления; верить в то, что проверка его деятельности проводится независимыми аудиторами. То же верно и для размещаемых в Фейсбуке фотографий, и для важного документа, выложенного на Dropbox. Эта модель ущербна, но до недавних пор децентрализованных альтернатив не существовало.
