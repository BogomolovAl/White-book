...
**A**: Биткойн — это цифровые деньги без централизованного посредника (вроде банка). Ethereum же предоставляет возможность писать контракты с участием (или без участия) этих денег. Контракты эти пишутся в виде программного кода, который 
